...
#define PLUG_IN_PROC "hipstagram_contrast"
#define PLUG_IN_BINARY "hipstagram_contrast"
...
static void run(const gchar *name, gint nparams, const GimpParam *param, gint *nreturn_vals, GimpParam **return_vals)
{
	...
	*nreturn_vals = 1;
	...
	gimp_tile_cache_ntiles(
		2 * MAX(drawable->width / gimp_tile_width() + 1,
...
void reset_default()
{
	...
	strcat(octave_params.cscript, "/.gimp-octave/adjcontrast.m");
